  ...
  getStyles: function getStyles() {
    ...
    return {
      root: {
        ...
        width: '100%',
        height: '100%',
        transition: open ? _stylesTransitions2['default'].easeOut('0ms', 'left', '0ms') : _stylesTransitions2['default'].easeOut('0ms', 'left', '450ms')
      },
      content: {
        boxSizing: 'border-box',
        WebkitTapHighlightColor: 'rgba(0,0,0,0)',
...
var Dialog = _react2['default'].createClass({
  ...
  getInitialState: function getInitialState() {
    process.env.NODE_ENV !== 'production' ? (0, _warning2['default'])(!this.props.actionFocus, 'actionFocus is deprecated on Dialog. Since actions JSON objects are deprecated.') : undefined;
    return {};
  },
