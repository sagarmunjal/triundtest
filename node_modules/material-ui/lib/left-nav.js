...
var LeftNav = _react2['default'].createClass({
  ...
  getStyles: function getStyles() {
    var theme = this.state.muiTheme.leftNav;
    var rawTheme = this.state.muiTheme.rawTheme;
  ...
  _testDeprecations: function _testDeprecations() {
    ...
    process.env.NODE_ENV !== 'production' ? (0, _warning2['default'])(!this.props.hasOwnProperty('header'), 'header will be removed in favor of composability. refer to the documentation for more information') : undefined;

    process.env.NODE_ENV !== 'production' ? (0, _warning2['default'])(!this.props.hasOwnProperty('menuItems'), 'menuItems will be removed in favor of composability. refer to the documentation for more information') : undefined;

    process.env.NODE_ENV !== 'production' ? (0, _warning2['default'])(!this.props.hasOwnProperty('menuItemClassName'), 'menuItemClassName will be removed with menuItems.') : undefined;

    process.env.NODE_ENV !== 'production' ? (0, _warning2['default'])(!this.props.hasOwnProperty('menuItemClassName'), 'menuItemClassName will be removed with menuItems.') : undefined;

    process.env.NODE_ENV !== 'production' ? (0, _warning2['default'])(!this.props.hasOwnProperty('menuItemClassNameLink'), 'menuItemClassNameLink will be removed with menuItems.') : undefined;

    process.env.NODE_ENV !== 'production' ? (0, _warning2['default'])(!this.props.hasOwnProperty('menuItemClassNameSubheader'), 'menuItemClassNameSubheader will be removed with menuItems.') : undefined;

    process.env.NODE_ENV !== 'production' ? (0, _warning2['default'])(!(typeof this.props.onChange === 'function'), 'onChange will be removed with menuItems.') : undefined;

    process.env.NODE_ENV !== 'production' ? (0, _warning2['default'])(!this.props.hasOwnProperty('selectedIndex'), 'selectedIndex will be removed with menuItems.') : undefined;
  },
